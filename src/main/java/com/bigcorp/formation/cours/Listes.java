...
public class Listes {
	...
	public static void main(String[] args) {
		...
		System.out.println("Affichage de la liste avec get(): ");
		for (int i = 0; i < maPremiereListe.size(); i++) {
			System.out.println(maPremiereListe.get(i));
		}
		
		// Tri puis affichage
		System.out.println("Affichage de la liste, après tri : ");
		Collections.sort(maPremiereListe);
		for (String elementDeLaListe : maPremiereListe) {
			System.out.println(elementDeLaListe);
		}
